...
// Execute query with ordering
  ...
  void _createNewDrawing() async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const DrawingPage(), // ✅ Remove isNewDrawing parameter
      ),
    );
  ...
  void _createCollaborativeSession() async {
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Divider(),
            // ✅ Add test option here
            ListTile(
              leading: const Icon(Icons.wifi_tethering, color: Colors.orange),
              title: const Text('Test Liveblocks Connection'),
              subtitle: const Text('Check connection status before creating'),
              onTap: () {
    ...
    if (choice == 'liveblocks') {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => LiveblocksCollaborativeDrawingPage( // ✅ Removed 'const'
            roomId: _generateRoomId(),
            userName: _authService.getDisplayName(),
            userColor: _authService.getUserColor(),
            isHost: true,
          ),
        ),
      );
  ...
  // Add this helper method to generate room ID
