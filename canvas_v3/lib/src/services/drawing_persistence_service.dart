...
// Save drawing state - updated method
  ...
  // Save images to Supabase storage and return their URLs
  Future<List<Map<String, dynamic>>> _saveImages(String drawingId,
      List<CanvasImage> images) async {
    ...
    for (final image in images) {
      try {
        ...
        if (bytes != null) {
          ...
          final fileName = '${drawingId}_${image.id}.png';
